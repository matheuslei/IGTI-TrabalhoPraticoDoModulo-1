...
function mapElements() {
  ...
  inputRangeRed = document.addEventListener("change", handleInputRangeChange);
  inputRangeGreen = document.addEventListener("change", handleInputRangeChange);
  inputRangeBlue = document.addEventListener("change", handleInputRangeChange);
}
